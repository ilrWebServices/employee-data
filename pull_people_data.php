...
function ldap2xml($ldap) {
  ...
  if (count($ldap)) {
    ...
    $temp_faculty = array('lac24', 'lha1', 'gc32', 'ljf8', 'lsg3', 'vmb2', 'zen2', 'srt82', 'so44', 'jds13','lrs95', 'elg234', 'jn497', 'lhc62', 'mjb62', 'cjb39', 'nah36', 'ak839', 'kal238', 'ko259', 'mcs378', 'ws283', 'jt693', 'aaw43', 'mfl55','no232','kfh7');
